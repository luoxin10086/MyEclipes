...
<BODY>
<FORM NAME="myform" METHOD="POST" action="day02/练习2：实现企业邮箱登录验证功能/doLogin.jsp" onSubmit="return checkLogin()"><!-- 触发点击事件 -->
<TABLE align="center">
<TR>
<TD>
<IMG src="day02/练习2：实现企业邮箱登录验证功能/Snap1.jpg"><DIV style="position:absolute; left: 490px; top: 216px; width: 356px;">
                      ...
                      height=27 align=right class=bld>用户名:&nbsp;</TD>
                        ...
                        <TR vAlign=top> 
                          <TD class=bld align=right height=40>&nbsp;</TD>
                            <TD  align=left valign="middle"><A href="#"><INPUT name="submit" type="image" src="day02/练习2：实现企业邮箱登录验证功能/login.gif" width="101" height="22" border="0" ></A> </TD>
                        </TR>
          </TABLE></DIV>
</TD>
</TR>
